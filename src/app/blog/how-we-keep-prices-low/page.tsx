...
export const metadata: Metadata = {
  ...
  keywords: ['affordable hosting', 'cheap web hosting', 'low price hosting', 'hosting business model', 'efficient hosting', 'value hosting', 'Grock Technologies pricing', 'hosting savings'],
};
