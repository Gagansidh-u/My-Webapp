...
export const metadata: Metadata = {
  ...
  description: 'A deep dive into why website speed is critical for user experience, conversion rates, and SEO. Learn how our NVMe hosting gives you a competitive advantage.',
